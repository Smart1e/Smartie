    ...
    for line in file:
        ...
        if line != "\n":
            try:
                ...
                try:
                    os.system(f"pip3.11 install {line}")
                except:
...
from GPTRequest import requestGPT
...
def listen():
    ...
    if deaf == '1' or deaf == 1:
        ...
        with sr.Microphone() as source:
            ...
            try:
                print('####################')
                get = r.recognize_google(audio, with_confidence=True)
                print('####################')
                get = str(get)
                print(get)
...
def search_comms():
    ...
    if inputString != 'error46069258':
        ...
        if 'what is' in inputString or 'who is' in inputString or 'what are' in inputString or 'who are' in inputString or 'why' in inputString:
            speak('Asking ChatGPT, Please wait...')
            speak(requestGPT(inputString))
        ...
        elif 'inspire me' in inputString:
           inspireme()
